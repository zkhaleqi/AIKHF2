 <section class="pagination">   
        ...
        $MySQL = " SELECT SQL_CALC_FOUND_ROWS id FROM farticles WHERE month='$month' AND status='show' ORDER BY id DESC LIMIT 10" . (($pagination->get_page() - 1) * $records_per_page) . ", " . $records_per_page . " ";
