 <section class="pagination">   
        ...
        $MySQL = " SELECT SQL_CALC_FOUND_ROWS id FROM farticles WHERE subcategory='Culture' AND status='show'  ORDER BY id LIMIT " . (($pagination->get_page() - 1) * $records_per_page) . ", " . $records_per_page . " ";
