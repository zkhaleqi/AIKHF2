 <section class="pagination">   
  <p align="center" id="page-pos">
      <a href="image_add.php?navigation_position=right">راست</a>| 
      <a href="image_add.php">وسط</a>|
      <a href="image_add.php?navigation_position=left">چپ</a> 
        ...
        $MySQL = " SELECT SQL_CALC_FOUND_ROWS id FROM fimages ORDER BY id LIMIT " . (($pagination->get_page() - 1) * $records_per_page) . ", " . $records_per_page . " ";
