...
<div class="container_12 header"> <!--Start Head Container-->
    ...
    <nav id="nav-bar"><!--Navigation Bar-->
        <ul>
          ...
          <li class="selected"><a href="reports.php">خبرها</a></li><!--
...
<div id="container" class="container_12"><!--Start main container-->
  <section id="main">
    ...
    <h1>خبرها به ترتیب تاریخ نشر</h1>
      <?php
          include 'dbcon.php';
          error_reporting(0);
		  if (isset($_GET["page"])) { $page  = $_GET["page"]; } else { $page=1; }; 
		  $start_from = ($page-1) * 10; 
		  $sql = "SELECT * FROM farticles WHERE status='show' ORDER BY id DESC LIMIT $start_from, 10";
